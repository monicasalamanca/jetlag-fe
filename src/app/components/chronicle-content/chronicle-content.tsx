    ...
    <main className={s.container}>
      ...
      <section className={s.mostPopular}>
        <div className={s.wrapper}>
          <h2>Most Popular</h2>
          <div className={s.cardWrapper}>
            <CardThree mockData={blogs[8]} color="purple" />
            <CardThree mockData={blogs[9]} color="blue" />
            <CardThree mockData={blogs[10]} color="red" />
      ...
      <section className={s.mostViewed}>
        <div className={s.wrapper}>
          ...
          <div className={s.cardWrapper}>
            ...
            <CardFive mockData={blogs[13]} />
            <CardFive mockData={blogs[14]} />
          </div>
        </div>
      </section>
    </main>
