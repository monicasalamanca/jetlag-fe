    ...
    <main className={s.container}>
      ...
      <section className={s.latestChronicles}>
        <div className={s.wrapper}>
          ...
          <div className={s.cardWrapper}>
            <CardOne mockData={mockData[0]} color="blue" />
            <CardOne mockData={mockData[1]} color="green" />
            <CardOne mockData={mockData[2]} color="purple" />
            <CardOne mockData={mockData[3]} color="orange" />
          </div>
        </div>
      </section>
      <section className={s.trending}>
        <div className={s.wrapper}>
          <h2>Trending</h2>
          <div className={s.cardWrapper}>
            <CardTwo mockData={mockData[4]} color="red" />
            <CardTwo mockData={mockData[5]} color="green" />
            <CardTwo mockData={mockData[6]} color="purple" />
            <CardTwo mockData={mockData[7]} color="orange" />
          </div>
        </div>
      </section>
      <section className={s.mostPopular}>
        <div className={s.wrapper}>
          <h2>Most Popular</h2>
          <div className={s.cardWrapper}>
            <CardThree mockData={mockData[8]} color="purple" />
            <CardThree mockData={mockData[9]} color="blue" />
            <CardThree mockData={mockData[10]} color="red" />
      ...
      {/* <section className={s.mostLiked}>
        <div className={s.wrapper}>
          <h2>Most Liked</h2>
          <div className={s.cardWrapper}>
            <CardFour mockData={mockData[12]} />
            <CardFour mockData={mockData[13]} />
