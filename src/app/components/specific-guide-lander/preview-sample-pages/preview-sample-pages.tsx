...
const PreviewSamplePages = forwardRef<HTMLElement, PreviewSamplePagesProps>(
  ({ guide }, ref) => {
    ...
    return (
      <section className={s.previewSamplePages} ref={ref}>
...
PreviewSamplePages.displayName = "PreviewSamplePages";
